...
int board_init(void)
{
	...
	#ifdef CONFIG_VYBRID_GPIO
	/* SoftDEL GPIO to Disable the BackLight  at  Start UP */

	/* SHDN - without it backlight/splash screen doesn't come up! */
        gpio_request(70, "SODIMM_PIN_59");
	...
	*/
	...
	/* SoftDEL GPIO to Disable the PWM Buzzer  at  Start UP */
	gpio_request(31, "SODIMM_PIN_67");
	gpio_direction_output(31, 1);
	gpio_set_value(31, 0);

	printf("Set the RTS low\n");
	/* Disable the RTS / turn transceiver off at Start UP */
