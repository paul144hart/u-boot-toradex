...
#define MTDPARTS_CUSTOM  "mtdparts=vf610_nfc:128k(vf-bcb)ro,1408k(u-boot)ro,512k(u-boot-env),-(ubi)"
#define VIDARGS "video=dcufb:pixclockpol:0,800x480-16@60"
...
/* local places */
#define CONFIG_IPADDR		10.40.17.251
#define CONFIG_NETMASK		255.255.255.0
#define CONFIG_SERVERIP		10.40.17.104
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"vidargs=video=dcufb:pixclockpol:0,800x480-16@60\0"\
	"mtdparts=" MTDPARTS_CUSTOM "\0" \
	NFS_BOOTCMD \
	SD_BOOTCMD \
	...
	"mtdparts=" MTDPARTS_CUSTOM "\0" \
	"setup=setenv setupargs fec_mac=${ethaddr} console=${console},${baudrate}n8 vt.global_cursor_default=0 ${memargs}\0" \
	"vidargs=" VIDARGS "\0"
...
#define CONFIG_SYS_PROMPT		"Setra Linux Platform #"
...
/*Kiran Bhoasle : WHy SPI is Required */
#if 1
/* Enable SPI support */
